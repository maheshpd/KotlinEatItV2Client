...
import com.createsapp.kotlineatitv2client.adapter.MyCommentAdapter
import com.createsapp.kotlineatitv2client.callback.ICommentCallBack
...
class CommentFragment : BottomSheetDialogFragment(), ICommentCallBack {
    ...
    override fun onCreateView(
        ...
        commentViewModel!!.mutableLiveDataCommentList.observe(
            viewLifecycleOwner,
            Observer { commentList ->
                val addapter = MyCommentAdapter(context!!, commentList)
                recycler_comment!!.adapter = addapter
            })
        return itemView
    }
